...
import javadb.memberDAO3;
import javadb.memberDAO4;

public class nMemberUI3 extends JFrame{
	
	JTextField id, pw, name, tel;
	JButton join, update, delete, search;
	
	public static void main(String[] args) {
		nMemberUI3 n = new nMemberUI3();
	}
	...
	public nMemberUI3() {
		...
		search.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				MemberVO result1 = dao.search(bag);
		...
		result.setPreferredSize(new Dimension(200, 250));
		...
		//10. 초기화면 요소 보이기 설정 (메뉴 선택4-1 버튼, view라벨 외 다 숨기기)
		id1.setVisible(false);id.setVisible(false);
		pw1.setVisible(false);pw.setVisible(false);
		name1.setVisible(false);name.setVisible(false);
		tel1.setVisible(false);tel.setVisible(false);
