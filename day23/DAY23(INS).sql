...
SELECT * FROM PRODUCT ORDER BY PRICE DESC	--2

SELECT * FROM PRODUCT ORDER BY COMPANY 	--3

SELECT DISTINCT COMPANY FROM PRODUCT 	--4

SELECT PRICE*5 AS PRICE5 FROM PRODUCT 	--5

SELECT NAME, COMPANY FROM PRODUCT WHERE PRICE=5000	--6

SELECT PRICE, COMPANY FROM PRODUCT WHERE PRICE BETWEEN 3000 AND 6000	--7

SELECT COMPANY, NAME FROM PRODUCT WHERE COMPANY != 'c100'	--8

SELECT NAME, PRICE  FROM PRODUCT WHERE COMPANY IN ('c100', 'c200')	--9

SELECT * FROM PRODUCT WHERE NAME LIKE '%4'	--10

SELECT * FROM PRODUCT WHERE CONTENT LIKE '%food%'	--11

UPDATE PRODUCT SET CONTENT = 'SOLD OUT' WHERE PRICE=5000	--12

UPDATE PRODUCT SET IMG = 'o.png' WHERE ID IN (100, 102)		--13

DELETE FROM PRODUCT WHERE COMPANY = 'c100'	--14

DELETE FROM PRODUCT	--15